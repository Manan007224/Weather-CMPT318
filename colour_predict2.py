...
def main():
    ...
    ## knn MODEL----------------------
    k = 7
    knn_rgb_model = KNeighborsClassifier(n_neighbors=k)
    ...
    results = knn_lab_model.predict(image_test_colour_data)

    data['color_label'] = results
    data.to_csv('image_data/KATKAM_labeled_colors2.csv',index=False)
